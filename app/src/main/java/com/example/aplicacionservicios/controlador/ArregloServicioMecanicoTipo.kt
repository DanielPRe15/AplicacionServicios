...
class ArregloServicioMecanicoTipo {
    ...
    fun obtenerPrecioPorCodigo(codigo: Int): Double {
        ...
        val SQL = "SELECT precio FROM tb_tiposerviciomeca WHERE cod_tiposerviciomeca = $codigo"
