...
class ArregloServicioMecanico {
    ...
    fun listado():ArrayList<ServicioMecanico>{
        var data=ArrayList<ServicioMecanico>()
        //abrir el acceso a la base de datos en modo lectura
        var cn: SQLiteDatabase = appConfig.BD.readableDatabase
        //sentencia SQL
        var SQL="select * from tb_serviciomeca"
        ...
        while(rs.moveToNext()) {
            ...
            val bean = ServicioMecanico(codigoServicio, codigoServi, codigoTipo,
