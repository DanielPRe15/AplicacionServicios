...
class ArregloServicioPlomeria {
    ...
    fun listado():ArrayList<ServicioPlomeria>{
        var data=ArrayList<ServicioPlomeria>()
        //abrir el acceso a la base de datos en modo lectura
        var cn: SQLiteDatabase = appConfig.BD.readableDatabase
        //sentencia SQL
        var SQL="select * from tb_servicioplome"
        ...
        while(rs.moveToNext()) {
            ...
            val bean = ServicioPlomeria(codigoServicio, codigoServi, codigoTipo,
